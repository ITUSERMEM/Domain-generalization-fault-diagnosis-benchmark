...
def train(model):
    ...
    for i in range(1, iteration + 1):
        ...
        try:
            ...
            tgt_data, tgt_label = next(tgt_iter)
        ...
        loss = cls_loss - confusion_loss_total*lambd+triplet*lambd
    ...
    for tasknumber in range(2):
        ...
        for taskindex in range(4):
            ...
            for repeat in range(10):
                ...
                src_loader = data_loader_1d.load_source_training(root_path, src_name1, src_name2, src_name3, src, FFT,
                                                                 class_num,
                                                                 batch_size, kwargs)

                tgt_loader = data_loader_1d.load_target_training(AP, SNR, root_path, src_name1, src_name2, src_name3,
                                                                 src, FFT, class_num,
                                                                 batch_size, kwargs)
